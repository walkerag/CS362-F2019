...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    case mine:
        ...
        cardMine(currentPlayer, state, handPos, choice1, choice2);
    ...
    case baron:
        ...
        cardBaron(currentPlayer, state, handPos, choice1);
    ...
    case minion:
        ...
        cardMinion(currentPlayer, state, handPos, choice1, choice2);
    ...
    case tribute:
        ...
        cardTribute(currentPlayer, nextPlayer, tributeRevealedCards, state, handPos, choice1, choice2);

    case ambassador:

        return cardAmbassador(currentPlayer, state, handPos, choice1, choice2);
